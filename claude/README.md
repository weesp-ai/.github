...
mkdir -p /tmp/bracket-claude \
  && curl -fsSL https://github.com/weesp-ai/.github/archive/refs/tags/claude-setup-v7.tar.gz \
...
Edit the files here and merge. Then cut a new tag (e.g. `claude-setup-v8`) and
